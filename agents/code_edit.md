...
Do not append any attribution byline, session URL, or "Generated by Claude Code" line to commit messages. No `Co-authored-by: Claude` trailers. No session URLs.
