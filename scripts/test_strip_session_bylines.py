...
class TestStripBylines(unittest.TestCase):
    ...
    def test_unchanged_for_markdown_link_without_session_prefix(self):
        # A [Claude Code] link not under session_ should not be stripped.
...
class TestHandlePullRequestReview(unittest.TestCase):
    ...
    def test_patches_review_body_when_byline_found(self, mock_requests):
        ...
        self.assertEqual(mock_requests.patch.call_args[1]["json"]["body"], "Looks good")
    ...
    def test_patches_markdown_footer_in_review_body(self, mock_requests):
        ...
        self.assertEqual(mock_requests.patch.call_args[1]["json"]["body"], "Review")
