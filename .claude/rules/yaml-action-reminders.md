...
1. Be consistent with Action versions across this project.
   Match the versions used by other workflows
   and *particularly* this same workflow.
2. If introducing an Action to this project, start with the current version
   (not just the most recent version you're aware of).
