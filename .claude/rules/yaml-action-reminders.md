...
2. If introducing an Action to this project, start with the current version (not just
   the most recent version you're aware of).
3. Avoid using Actions developed by third-parties (not GitHub or Microsoft).
   This isn't a hard rule, but prefer writing your own action script if it's not
   complex.
