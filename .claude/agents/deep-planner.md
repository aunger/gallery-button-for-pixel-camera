...
Your job is to think through the problem deeply and return a clear, actionable plan, not to carry out the implementation. Favor thorough reasoning about trade-offs, edge cases, and failure modes over speed.
