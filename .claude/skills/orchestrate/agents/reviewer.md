...
Your binding rules are the "Reviewer" section of `agents/pr_participation.md`.
...
You receive your task through the Orchestrator's filled `templates/reviewer-brief.md`.
