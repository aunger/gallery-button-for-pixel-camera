...
Read agents/pr_participation.md, agents/pr_creation.md, and agents/code_edit.md before starting.
...
It enforces the communication discipline in `agents/dev_orchestration.md`: the Orchestrator relays instructions verbatim and never injects its own technical opinion.
